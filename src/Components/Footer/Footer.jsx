      ...
      <div className="footer_box">
        <div className="footer_card2">
          <div className="map_box" >
            <iframe className="map_container" src="https://yandex.com/map-widget/v1/?um=constructor%3A9664aa94837b0cac5193d27d6c49cf751641c81314f8f30385d4ec9df29b066a&amp;source=constructor" width="643" height="572" frameborder="0"></iframe>
          </div>
        </div>
